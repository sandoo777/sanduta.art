    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Creează cont nou</h1>
          <p className="text-gray-600 dark:text-gray-400">Începe să creezi astăzi</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-blue-100/50 dark:shadow-gray-900/50 p-8 backdrop-blur-sm border border-gray-100 dark:border-gray-700 animate-slide-up">
          {generalError && (
            <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl animate-shake">
              <div className="flex items-center gap-3">
                ...
                <p className="text-red-700 dark:text-red-300 text-sm font-medium">{generalError}</p>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <input 
                ...
                required 
                className="mt-1 w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 cursor-pointer" 
              />
              <span className="text-sm text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                ...
                {" "}și{" "}
                <a href="/privacy" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium hover:underline">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 font-medium">sau</span>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-gray-600 dark:text-gray-400">
              Ai deja cont?{" "}
              <a href="/login" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold transition-colors hover:underline">
                Conectează-te
              </a>
            </p>
          </div>
