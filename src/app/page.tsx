      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Link href="/products?category=Фото%20на%20бумаге" className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            ...
            <Link href="/products?category=Холст" className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            ...
            <Link href="/products?category=Кружки" className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            ...
            <Link href="/products?category=Футболки" className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            ...
            <Link href="/products?category=Чехлы%20для%20телефона" className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            ...
            <Link href="/products?category=Календари" className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            ...
            <Link href="/products?category=Книги" className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            ...
            <Link href="/products?category=Пазлы" className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
