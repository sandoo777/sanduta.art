    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="max-w-md bg-red-50 border border-red-200 rounded-lg p-6 md:p-8 text-center">
            <svg className="w-12 h-12 md:w-16 md:h-16 mx-auto text-red-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <h2 className="text-lg md:text-xl font-semibold text-red-700 mb-2">Error Loading Products</h2>
            <p className="text-sm md:text-base text-red-600 mb-4">{error}</p>
            <button
              onClick={() => window.location.reload()}
              className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition text-sm md:text-base"
            >
              Retry
            </button>
          </div>
